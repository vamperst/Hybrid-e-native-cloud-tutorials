1. Execute o comando `cd ~/environment/Hybrid-e-native-cloud-tutorials/demos/State/` para entrar na pasta do exercicío.'
2. Entre na pasta 'S3' com o comando `cd S3`
3. Execute o comando `terraform init`
4. Utilizando o IDE altere o aquivo 's3.tf' que esta em 'Hybrid-e-native-cloud-tutorials/demos/State/S3'. Coloque sua turma e seu rm noo locais indicados. Sem espaços e letras maiúsculas. Isso é necessário pois os nomes de buckets são unicos em toda a AWS não só em sua conta. 
...
9.  Utilizendo o IDE altere o arquivo state.tf que esta no diretório 'Hybrid-e-native-cloud-tutorials/demos/State/test'. No campo bucket coloque o mesmo nome que utilizou para criar o bucket acima.
