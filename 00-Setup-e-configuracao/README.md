...
13. Execute o comando `git clone https://github.com/vamperst/Hybrid-e-native-cloud-tutorials.git` para clonar o repositório com os exercicios.
14. Execute o comando `cd Hybrid-e-native-cloud-tutorials/` para entrar na pasta criada pelo git
